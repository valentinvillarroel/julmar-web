            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-8 md:mb-12">
                    <div className="mb-6 md:mb-0 text-center md:text-left">
                        <span className="text-julmar-green font-bold uppercase tracking-widest mb-2 block text-xs md:text-sm">Catálogo Operativo para la Gran Minería</span>
                        <h2 className="text-3xl md:text-5xl font-black text-julmar-dark uppercase">Flota de Maquinaria Pesada Disponible</h2>
                    </div>
                </div>
